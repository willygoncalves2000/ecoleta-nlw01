...
const Detail = () => {
  ...
  // Busca os dados do ponto correspondente ao ID recebido pela rota
  useEffect(() => {
  ...
  function handlerWhatsapp() {
    Linking.openURL(`whatsapp://send?phone${data.point.whatsapp}&text=Tenho interesse em seu Ponto de Coleta`)
  }
