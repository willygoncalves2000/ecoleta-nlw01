...
import { View , Image, StyleSheet, TouchableOpacity, Alert, Text, ScrollView, SafeAreaView } from 'react-native';
...
const Points = () => {
  ...
  // Envia o ID do Point para a tela de Detail
